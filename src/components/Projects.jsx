const books = [
  {
    ...
    desc: 'Mi primera gran obra sistemática. Expuse los principios del estudio de tiempos, las tarifas diferenciales y la organización del trabajo en el taller industrial. Fundamento metodológic[...]
  ...
  },
  {
    ...
    desc: 'Mi obra cumbre. Los cuatro principios fundamentales: ciencia en lugar de empirismo, selección científica, cooperación armoniosa y división equitativa de responsabilidades. Traducida[...]
  ...
  return (
    <section id="proyectos" className="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
      <div className="flex items-center justify-between mb-4">
        ...
        <button id="viewAllBtn" name="viewAll" className="text-sm font-semibold text-[#0A66C2] hover:underline">Ver todas</button>
      </div>
          ...
          >
            ...
            >
              ...
              <svg className="w-7 h-7 text-white/60" fill="currentColor" viewBox="0 0 24 24">
                <path d="M11.25 4.533A9.707 9.707 0 006 3a9.735 9.735 0 00-3.25.555.75.75 0 00-.5.707v14.25a.75.75 0 001 .707A8.237 8.237 0 016 18.75c1.995 0 3.823.707 5.25 1.875V4.533zM12.75 20.6[...]
              </svg>
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-gray-500 mt-0.5 flex items-center gap-1">
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 008.716-6.747M12 21a9.004 9.004 0 01-8.716-6.747M12 21c2.485 0 4.5-4.03 4.5-9S14.485 3 12 3m0 18c-2.485[...]
                </svg>
                {book.publisher}
              </p>
              ...
              <div className="flex items-center gap-4 mt-2.5 text-xs text-gray-400">
                <span className="flex items-center gap-1">
                  <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 1[...]
                    </svg>
                  {book.pages} págs.
                </span>
                <span className="flex items-center gap-1">
                ...
                <button id={`readBtn_${i}`} name={`read_${i}`} className="text-[#0A66C2] font-medium hover:underline">Leer extracto</button>
              </div>
            </div>
          </div>
        ))}
